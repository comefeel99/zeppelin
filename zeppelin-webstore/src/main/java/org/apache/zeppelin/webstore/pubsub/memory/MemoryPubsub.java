 ...
 */
package org.apache.zeppelin.webstore.pubsub.memory;
...
public class MemoryPubsub implements Pubsub {
  private final Topic dummyTopic;
  ...
  public MemoryPubsub() {
    dummyTopic = new Topic() {
      ...
      public void publish(Object o) {
        subscribers.stream().forEach(s -> s.onMessage(o));
      }
